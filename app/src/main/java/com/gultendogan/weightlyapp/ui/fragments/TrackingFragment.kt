...
import com.gultendogan.weightlyapp.other.Constants.MAP_ZOOM
import com.gultendogan.weightlyapp.other.Constants.POLYLINE_COLOR
...
class TrackingFragment : Fragment(R.layout.fragment_tracking) {
    ...
    private fun endRunAndSaveToDb() {
        map?.snapshot { bmp ->
            ...
            val caloriesBurned = ((distanceInMeters / 1000f) * 80.0).toInt()
